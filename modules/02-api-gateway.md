...
An API gateway is the single entry point for clients. It routes requests, handles auth, rate limiting, TLS, and aggregation — but should not contain domain business logic.

## Concept

### Daily-life analogy

Like a hotel front desk: guests check in once, and the desk routes them to the right department.
