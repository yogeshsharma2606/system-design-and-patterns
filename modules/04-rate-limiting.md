# Module 04 — Rate Limiting

## TL;DR

Rate limiting controls how many requests a client can make in a time window. Token bucket is a good default. Key by authenticated user when possible. Return 429 with Retry-After.

## Concept

### Daily-life analogy

Like a nightclub bouncer letting in a fixed number of people per hour to prevent overcrowding.
