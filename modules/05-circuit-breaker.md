# Module 05 — Circuit Breaker

## TL;DR

A circuit breaker stops calling a failing dependency after a threshold, failing fast instead of waiting. States: closed, open, half-open. Combine with timeouts, retries, and idempotency.

## Concept

### Daily-life analogy

Like a home circuit breaker that trips when too much current flows, protecting the whole house.
