# Module 06 — Message Queues & Event-Driven Design

## TL;DR

Queues decouple producers and consumers for async work. Assume at-least-once delivery and make consumers idempotent. Use streams (Kafka) when multiple consumers need the same event history.

## Concept

### Daily-life analogy

Like a restaurant order ticket system: the waiter takes the order and the kitchen processes it independently.
