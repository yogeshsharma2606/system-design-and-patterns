...
Authenticate at the edge, authorize in the owning service. Encrypt in transit and at rest. Rate-limit abuse-prone endpoints. Never log secrets. Scope every query by tenant.

## Concept

### Daily-life analogy

Like building security: badge at the lobby (auth), key card per room (authorization), cameras in hallways (audit logs).
