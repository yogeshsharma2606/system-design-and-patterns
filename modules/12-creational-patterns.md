# Module 12 — Creational Design Patterns

## TL;DR

Creational patterns manage object creation: Singleton (one instance), Factory (runtime selection), Abstract Factory (families), Builder (complex objects), Prototype (cloning).

## Concept

### Daily-life analogy

Like different ways to get a meal: vending machine (factory), custom order (builder), or copying yesterday's order (prototype).
