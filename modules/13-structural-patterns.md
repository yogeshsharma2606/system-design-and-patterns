# Module 13 — Structural Design Patterns

## TL;DR

Structural patterns compose objects: Adapter (interface mismatch), Decorator (add behavior), Facade (simplify subsystem), Proxy (control access), Composite (tree structures).

## Concept

### Daily-life analogy

Like adapters for different power plugs, or a remote control (proxy) that manages access to the TV.
