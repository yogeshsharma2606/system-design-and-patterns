...
SOLID guides maintainable OOP: Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion. Explain through examples, not definitions alone.

## Concept

### Daily-life analogy

Like team roles: each person has one job (SRP), new hires don't require rewriting the org chart (OCP).
